...
//   orders:business:<phoneNumberId> -> SET of order ids, for the dashboard's order table
...
/**
 * List every order for a business, newest first. This is what the
 * dashboard's order table reads from — same pattern as listConversations()
 * in lib/db.js.
 */
